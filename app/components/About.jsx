       ...
       className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        transition={{duration:0.6, delay:0.8}}
         className='flex-1'>
            ...
            I specialize in both front-end and back-end development, utilizing modern technologies to create seamless user experiences. 
            My goal is to continuously learn and grow in the field of web development, 
            contributing to innovative projects and solving complex problems.
            </p>
            ...
            className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                {infoList.map(({icon, iconDark, title, description}, index) => (
                    ...
                    key={index} className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50'>
                        <Image src={DarkMode ? iconDark : icon} alt={title} />
